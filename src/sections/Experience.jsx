...
const PastExperienceRow = ({ exp }) => {
	...
	return (
		<motion.div
			...
			{/* Indicador de línea de tiempo adaptativo */}
			...
			<h4 className='text-lg font-black text-structural group-hover:text-white transition-colors uppercase tracking-tight'>{exp.title}</h4>
		...
		<section id='experience' className='py-16 sm:py-20 bg-concrete'>
			<AnimatedSection>
				<div className='container mx-auto px-6 max-w-5xl text-left'>
					...
					{/* Bloque de experiencia actual sólido e interactivo */}
